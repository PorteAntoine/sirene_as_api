...
class GetJuneMonthlyStockLink < SireneAsAPIInteractor
  around do |interactor|
    stdout_info_log "Visiting June stock distant directory"
    interactor.call
    stdout_success_log "Retrieved June monthly stock link : #{context.link}"
    puts
  end

  def call
    last_monthly_stock_relative_link = "sirene_201706_L_M.zip"

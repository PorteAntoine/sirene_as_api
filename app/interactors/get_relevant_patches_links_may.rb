...
class GetRelevantPatchesLinksMay < SireneAsAPIInteractor
  ...
  def call
    relevant_patches_relative_links =
      sirene_update_and_stock_links.select do |l|
        ...
        padded_day_number = $1
        padded_day_number && (padded_day_number > padded_latest_etablissement_mise_a_jour_day_number) && (padded_day_number <= "181")
      end
  ...
  def padded_latest_etablissement_mise_a_jour_day_number
    @padded_latest_etablissement_mise_a_jour_day_number ||= begin
      ...
      latest_etablissement_mise_a_jour = EtablissementMayToJune.latest_mise_a_jour
